   ...
   <div id="optionsframework-sidebar">
      <div class="metabox-holder">
         <div class="postbox">
            ...
            <div class="inside">
               <div class="option-btn"><a class="btn upgrade" target="_blank" href="<?php echo esc_url( 'http://themegrill.com/themes/ample-pro/' ); ?>"><?php esc_attr_e( 'Upgrade to Pro' , 'ample' ); ?></a></div>
