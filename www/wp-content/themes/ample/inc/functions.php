...
function ample_scripts() {
   ...
   */
   ...
   $slider = 0;
   for($i=1; $i<=4; $i++) {
      $slider_image = of_get_option('ample_slider_image' . $i, '');
      if ( !empty($slider_image)) $slider++;
   }

   if ( ($slider > 1) && is_front_page() && of_get_option( 'ample_activate_slider', '0' ) == '1' ) {
...
function ample_exclude_category( $query ) {
   ...
   $ample_cat_num = of_get_option( 'ample_hide_category', '');
...
function ample_favicon() {
   if ( of_get_option( 'ample_activate_favicon', '0' ) == '1' ) {
      $ample_favicon = of_get_option( 'ample_favicon', '' );
...
function ample_custom_css() {
   $primary_color = of_get_option( 'ample_primary_color', '#80abc8' );
   $ample_internal_css = '';
   ...
   if( of_get_option( 'ample_header_title_background_image' ) ) {
      $ample_internal_css .= ' .header-post-title-container { background-image: url("'.of_get_option( 'ample_header_title_background_image' ).'");background-size:cover; }';
   }
   if( of_get_option( 'ample_title_bar_background_color', '#80abc8' ) != '#80abc8' ) {
      $ample_internal_css .= ' .header-post-title-container { background-color: '.of_get_option( 'ample_title_bar_background_color', '#80abc8' ).'; }';
   }
   if( of_get_option( 'ample_header_title_color', '#ffffff' ) != '#ffffff' ) {
      $ample_internal_css .= ' .header-post-title-class, .breadcrumb, .breadcrumb a { color: '.of_get_option( 'ample_header_title_color', '#ffffff' ).'; }';
   }
   ...
   $ample_custom_css = of_get_option( 'ample_custom_css', '' );
...
function ample_body_class( $classes ) {
   ...
   $ample_default_layout = of_get_option( 'ample_default_layout', 'right_sidebar' );
   $ample_default_page_layout = of_get_option( 'ample_pages_default_layout', 'right_sidebar' );
   $ample_default_post_layout = of_get_option( 'ample_single_posts_default_layout', 'right_sidebar' );
   ...
   if( of_get_option( 'ample_site_layout', 'wide' ) == 'wide' ) {
      $classes[] = 'wide';
   }
   else {
      $classes[] = '';
